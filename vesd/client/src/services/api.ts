...
export const endpoints = {
  ...
  createDesignerProfile: (body: unknown) => api<any>('/designers/profile', { method: 'POST', body: JSON.stringify(body) }),
  updateDesignerProfile: (body: unknown) => api<any>('/designers/profile', { method: 'PATCH', body: JSON.stringify(body) }),
  ...
  createDispute: (body: { projectId: string; reason: string; description: string; evidenceFiles?: any[] }) => api<any>('/disputes', { method: 'POST', body: JSON.stringify(body) }),
